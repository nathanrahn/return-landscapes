...
class ReplayBuffer(Dataset):
    def __init__(self, observation_dim: int, action_dim: int,
                 capacity: int):
        qp_states = np.empty((capacity,), dtype=brax.physics.base.QP)
        ...
        super().__init__(qp_states=qp_states,
    ...
    def insert(self, qp_state: brax.physics.base.QP, observation: np.ndarray, action: np.ndarray,
               reward: float, mask: float, done_float: float,
               next_observation: np.ndarray):
        self.qp_states[self.insert_index] = qp_state
