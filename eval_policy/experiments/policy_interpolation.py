...
class PolicyInterpolation:
    def __init__(self, run_names1, run_names2, seeds1, ckpts1, seeds2, ckpts2, batch_size,
                 num_points, num_purd_samples, noise_amount):
        self.run_names1 = run_names1
        self.run_names2 = run_names2
        self.seeds1 = seeds1
        self.seeds2 = seeds2
        self.ckpts1 = ckpts1
        self.ckpts2 = ckpts2
    ...
    def run(self, output_dir, this_job_result_dir):
        for args in tqdm(zip(self.run_names1, self.run_names2, self.seeds1, self.ckpts1, self.seeds2, self.ckpts2)):
            self.run_one(*args)
