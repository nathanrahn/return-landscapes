...
if __name__ == "__main__":
    ...
    # Closest points to e.g. 10%, 20%, ..., 100%
    checkpoints = {
        int(num_updates * i / args.num_checkpoints): i for i in range(1, args.num_checkpoints + 1)
    }

    for update in range(1, num_updates + 1):
        if update in checkpoints:
            save_checkpoint(agent, optimizer, checkpoints[update], args.num_checkpoints, run_name, base_path)
